...
;!function(){threedo.Scene=function(e){if(threedo.Model.call(this),!e.name)throw"A valid name was not provided to create this scene";var t=e.name;Object.defineProperty(this,"name",{get:function(){return t},set:function(e){t=e}});var n=45;Object.defineProperty(this,"viewAngle",{get:function(){return n},set:function(e){n=e}});var r=.1;Object.defineProperty(this,"near",{get:function(){return r},set:function(e){r=e}});var i=1e3;Object.defineProperty(this,"far",{get:function(){return i},set:function(e){i=e}});var o={};Object.defineProperty(this,"renderer",{get:function(){return o},set:function(e){o=e}});var a=new THREE.Scene;Object.defineProperty(this,"scene",{get:function(){return a},set:function(e){a=e}});var c;Object.defineProperty(this,"backgroundColor",{get:function(){return c},set:function(e){c=e}});var s;Object.defineProperty(this,"backgroundAlpha",{get:function(){return s},set:function(e){s=e}});var d={};Object.defineProperty(this,"skybox",{get:function(){return d},set:function(e){d.materials=[];for(var t=0;t<e.length;++t)d.materials.push(new THREE.MeshBasicMaterial({map:THREE.ImageUtils.loadTexture(e[t]),side:THREE.BackSide}));d.mesh||(d.mesh=new THREE.Mesh(new THREE.BoxGeometry(i,i,i),new THREE.MeshFaceMaterial(d.materials)),a.add(d.mesh))}});var u=e.$container||threedo.$container;Object.defineProperty(this,"$container",{get:function(){return u},set:function(e){u=e}});var f={};Object.defineProperty(this,"nodes",{get:function(){return f}}),this.add=function(e){if(!f[e.name]){f[e.name]=e;var t=e.Camera||e.Mesh||e.Object3D||e.Light;return a.add(t),e}throw'A node already exists in this scene named "'+e.name+'"'},this.find=function(e){return f[e]||null};var h=.1,p=-h;this.update=function(){var e=threedo.update.time-p>=h?!0:!1;for(var t in f)f.hasOwnProperty(t)&&("function"==typeof f[t].update&&f[t].update(),e&&"function"==typeof f[t].fixedUpdate&&f[t].fixedUpdate());e&&(o.updateDimensions(),p=threedo.update.time)};var m=function(){requestAnimationFrame(m),stats.begin(),threedo.update(),threedo.scene&&threedo.scene.update(),o.render(),stats.end()};this.type="Scene";var v=new threedo.Camera({name:"mainCamera",near:r,far:i,scene:this});o=new threedo.Renderer({camera:v,scene:this}),m()},threedo.Scene.prototype=Object.create(threedo.Model.prototype),threedo.Scene.prototype.constructor=threedo.Scene}();
