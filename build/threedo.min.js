...
;!function(){var e=function(e){return"string"==typeof e?threedo._spaces[e]?threedo._spaces[e]:null:("object"==typeof e&&e.name&&(threedo._spaces[e.name()]=e),threedo._spaces)};threedo.spaces=e,threedo._spaces={}}();
...
;!function(){var n=function(n,e){for(var t={},r=function(n){return n&&(this._value=n),this._value},u=0;u<n.length;u+=1)t[n[u]]=r.bind({_value:e[n[u]]});return t};threedo.Model=n}();
...
;!function(){var e=function(e){var n=["name","nodes"],e=e||{};e.nodes={};var o=new threedo.Model(n,e);return o.node=function(e){if("string"==typeof e)return o.nodes()[e]?o.nodes()[e]:null;if("object"==typeof e&&e.name){var n=e;return o.nodes()[n.name()]=n,n}return!1},o};threedo.Space=e}();
;!function(){var e=function(e,a){var e=e||{},a=a||{};e.name||e.push("name"),e.baseType||e.push("baseType"),a.baseType="Node";var n=new threedo.Model(e,a);return n};threedo.Node=e}();
;!function(){var o=function(o){var t=["obj3D","type"],o=o||{};o.type="Node3D";var i=new threedo.Node(t,o);return i.position=function(o,t,e){var n=this.mesh()||this.obj3D();return n?(n.position.x=o,n.position.y=t,n.position.z=e,i):this},i};threedo.Node3D=o}();
;
