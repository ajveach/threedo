...
;!function(){var e={};Object.defineProperty(threedo,"spaces",{get:function(){return e}}),threedo.space=function(n){return"string"==typeof n?e[n]?e[n]:null:void 0},threedo.space.add=function(n){return n instanceof threedo.Space?(e[n.name]=n,n):!1}}();
...
;!function(){threedo.Space=function(e){threedo.Node.call(this,e.name),this.type="Space";var t={};Object.defineProperty(this,"nodes",{get:function(){return t}}),this.node=function(e){return t[e]?t[e]:null},this.node.add=function(e){return e instanceof threedo.Node?(t[e.name]=e,e):!1}},threedo.Space.prototype=Object.create(threedo.Node.prototype),threedo.Space.prototype.constructor=threedo.Space}();
