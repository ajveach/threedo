...
;!function(){threedo.UI.select=function(e){var t=this;this.typeSpecificClass="threedo-UI-select",threedo.UI.call(this,e),this.$.hover(function(){t.$.addClass("hover")},function(){t.collapse(),t.$.removeClass("hover")});var o=$("<div />").addClass("options").appendTo(this.$);if(this.expand=function(){t.$.children(".options").show()},this.collapse=function(){t.$.children(".options").hide()},this.toggle=function(){t.expanded()?t.collapse():t.expand()},this.expanded=function(){return t.$.children(".options").is(":visible")},!e.label)throw"A label is required to create a UI.select object";var n=null,i=null;Object.defineProperty(this,"label",{get:function(){return n},set:function(e){n=e,this.refreshLabel()}}),this.refreshLabel=function(){i?i.children("span").html(t.label):(i=$("<div />").addClass("label").prependTo(t.$),$("<span />").html(t.label).appendTo(i),$("<div />").addClass("arrow-down").prependTo(i),i.on("click",t.toggle))},this.label=e.label;var s=[];if(Object.defineProperty(this,"options",{get:function(){return s}}),this.options.add=function(e){var e=e;if("string"==typeof e)var e={name:e,value:e};s.push(e),$("<div />").html(e.name).attr("data-value",e.value).attr("data-index",s.length-1).addClass("option").appendTo(o)},this.options.remove=function(e){return o.children('[data-index="'+e+'"]').remove(),delete s[e],this.options},this.options.clear=function(){return s=[],o.children(".option").remove(),this.options},e.options)for(var r in e.options)e.options.hasOwnProperty(r)&&this.options.add(e.options[r]);this.$.prependTo("global"===this.context?threedo.scene.renderer.$container:this.context),this.type="UI.select"},threedo.UI.select.prototype=Object.create(threedo.UI.prototype),threedo.UI.select.prototype.constructor=threedo.UI.select}();
;
