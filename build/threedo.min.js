...
;!function(){var r=function(){this.utility={},this.version="0.0.1";var r={};Object.defineProperty(this,"$container",{get:function(){if(!r.primary){var t=$("#threedo,[data-threedoType='container']");t.each(function(){var t=$(this),e=t.attr("data-threedoName");if(!e&&r.primary)throw"A name was not provided for the threedo container";e&&(r[e]=t),r.primary||(r.primary=t)})}return r}})};window.threedo=new r}();
