...
;!function(){var i={utility:{}};window.threedo=i}();
;!function(){var i=function(i,t){for(var n={},o=function(i){return i&&(this._value=i),this._value},e=0;e<i.length;e+=1)n[i[e]]=o.bind({_value:t[i[e]]});return n.position=function(i,t,o){var e=this.mesh()||this.obj3D();return e?(e.position.x=i,e.position.y=t,e.position.z=o,n):this},n};threedo.Model=i}();
...
;!function(e){var n=0,t=0,r=45,i=null,o=.1,a=1e4,u=null,s=null,c=null,l=null,d=3355443,f=1,h=null,E={light:{},mesh:{},empty:{}},m=function(){return l};m.$container=null,m.width=function(e){var e=e||!1;return e?(n=e,m.aspectRatio(n/t),u.setSize(n,t),void 0):n},m.height=function(e){var e=e||!1;return e?(t=e,m.aspectRatio(n/t),u.setSize(n,t),void 0):t},m.viewAngle=function(e){var e=e||!1;return e?void(r=e):r},m.aspectRatio=function(e){var e=e||!1;return e?(i=e,void(s&&(s.aspect=i,s.updateProjectionMatrix()))):i},m.near=function(e){var e=e||!1;return e?void(o=e):o},m.far=function(e){var e=e||!1;return e?void(a=e):a},m.backgroundColor=function(e){var e=e;return"number"!=typeof e?d:(d=e,void u.setClearColor(d,f))},m.backgroundAlpha=function(e){var e=e;return"number"!=typeof e?f:(f=e,void u.setClearColor(d,f))},m.skybox=function(e){if(!e)return h;if(h||(h={}),e){h.materials=[];for(var n=0;6>n;n+=1)h.materials.push(new THREE.MeshBasicMaterial({map:THREE.ImageUtils.loadTexture(e[n]),side:THREE.BackSide}))}h.mesh||(h.mesh=new THREE.Mesh(new THREE.BoxGeometry(m.far(),m.far(),m.far()),new THREE.MeshFaceMaterial(h.materials)),c.add(h.mesh)),console.log(h)},m.renderer=function(){return u},m.camera=function(){return s},m.camera.position=function(e,n,t){console.log(e,n,t),console.log(s.position),c.position.set(e,n,t)},m.light=function(e){return E.light[e]},m.mesh=function(e){return E.mesh[e]},m.add=function(e,n,t){return E[e]?(E[e][n]=t,l.add(t),t):!1},m.init=function(h){m.$container=$("#threedo"),n=m.$container.width(),t=m.$container.height(),m.aspectRatio(n/t),u=new THREE.WebGLRenderer,s=new THREE.PerspectiveCamera(r,i,o,a),l=new THREE.Scene,c=new THREE.Object3D,c.add(s),l.add(c),u.setSize(n,t),u.setClearColor(d,f),m.$container.append(u.domElement);var E=new THREE.PointLight(16777215);E.position.x=10,E.position.y=50,E.position.z=130,m.add("light","demoLight",E),e.utility.loader=new THREE.JSONLoader,$(window).resize(e.onResize),p(),h()};var p=function(){requestAnimationFrame(p),stats.begin(),e.update(),u.render(l,s),stats.end()};e.scene=m}(threedo);
