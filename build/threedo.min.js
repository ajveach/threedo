...
;!function(e){var n=0,t=0,r=45,i=null,o=.1,a=1e4,u=null,s=null,c=null,d=null,l=3355443,f=1,h=null,E={light:{},mesh:{},empty:{}},m=function(){return d};m.$container=null,m.width=function(e){var e=e||!1;return e?(n=e,m.aspectRatio(n/t),u.setSize(n,t),void 0):n},m.height=function(e){var e=e||!1;return e?(t=e,m.aspectRatio(n/t),u.setSize(n,t),void 0):t},m.viewAngle=function(e){var e=e||!1;return e?void(r=e):r},m.aspectRatio=function(e){var e=e||!1;return e?(i=e,void(s&&(s.aspect=i,s.updateProjectionMatrix()))):i},m.near=function(e){var e=e||!1;return e?void(o=e):o},m.far=function(e){var e=e||!1;return e?void(a=e):a},m.backgroundColor=function(e){var e=e;return"number"!=typeof e?l:(l=e,void u.setClearColor(l,f))},m.backgroundAlpha=function(e){var e=e;return"number"!=typeof e?f:(f=e,void u.setClearColor(l,f))},m.skybox=function(e){if(!e)return h;if(h||(h={}),e){h.materials=[];for(var n=0;6>n;n+=1)h.materials.push(new THREE.MeshBasicMaterial({map:THREE.ImageUtils.loadTexture(e[n]),side:THREE.BackSide}))}h.mesh||(h.mesh=new THREE.Mesh(new THREE.BoxGeometry(m.far(),m.far(),m.far()),new THREE.MeshFaceMaterial(h.materials)),c.add(h.mesh))},m.renderer=function(){return u},m.camera=function(){return s},m.camera.position=function(e,n,t){console.log(e,n,t),console.log(s.position),c.position.set(e,n,t)},m.light=function(e){return E.light[e]},m.mesh=function(e){return E.mesh[e]},m.add=function(e,n,t){return E[e]?(E[e][n]=t,d.add(t),t):!1},m.init=function(h){m.$container=$("#threedo"),n=m.$container.width(),t=m.$container.height(),m.aspectRatio(n/t),u=new THREE.WebGLRenderer,s=new THREE.PerspectiveCamera(r,i,o,a),d=new THREE.Scene,c=new THREE.Object3D,c.add(s),d.add(c),u.setSize(n,t),u.setClearColor(l,f),m.$container.append(u.domElement);var E=new THREE.PointLight(16777215);E.position.x=10,E.position.y=50,E.position.z=130,m.add("light","demoLight",E),e.utility.loader=new THREE.JSONLoader,$(window).resize(e.onResize),p(),h()};var p=function(){requestAnimationFrame(p),stats.begin(),e.update(),u.render(d,s),stats.end()};e.scene=m}(threedo);
...
;!function(){threedo.Node=function(e){threedo.Model.call(this),this.type="Node";var t=e;Object.defineProperty(this,"name",{get:function(){return t},set:function(e){t=e}})},threedo.Node.prototype=Object.create(threedo.Model.prototype),threedo.Node.prototype.constructor=threedo.Node}();
;!function(){threedo.Space=function(e){threedo.Node.call(this,e.name),this.type="Space";var t={};Object.defineProperty(this,"nodes",{get:function(){return t}});var o=function(){for(var e in t){var o=t[e];o instanceof threedo.Node&&"function"==typeof o.update&&o.update()}};threedo.update.add('threedo.space["'+this.name+'"].update',o),this.node=function(e){if("string"==typeof e){if(t[e])return t[e]}else{if(e instanceof threedo.Node){var o=e;return t[o.name]=o,o}if("object"==typeof e){var n=e;if(n.type&&n.name){var o=null;return"function"==typeof n.type?o=new n.type(n):"string"===n.type&&"function"==typeof threedo[n.type]&&(o=new threedo[n.type](n)),o&&(t[n.name]=o),o}}}return null},this.node.add=function(e){return this(e)}},threedo.Space.prototype=Object.create(threedo.Node.prototype),threedo.Space.prototype.constructor=threedo.Space}();
;!function(){threedo.Node3D=function(e){threedo.Node.call(this,e.name),this.type="Node3D"},threedo.Node3D.prototype=Object.create(threedo.Node.prototype),threedo.Node3D.constructor=threedo.Node3D}();
;
