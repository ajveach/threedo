...
;!function(){var e=function(){for(var e in this.extend.list)if(this.extend.list.hasOwnProperty(e)){var i=this.extend.list[e];if(threedo[i.name])throw'Modules cannot use the names of core threedo properties. You cannot add a module named "'+i.name+'".';if("object"==typeof i.requirements){for(var n in i.requirements)if(i.requirements.hasOwnProperty(n)){if(!this.extend.list[i.requirements[n]])throw'The module "'+i.name+'" requires the module "'+i.requirements[n]+'", but it was not included in this build.';r(i.name,i.requirements[n])}}else if("string"==typeof i.requirements){if(!this.extend.list[i.requirements])throw'The module "'+i.name+'" requires the module "'+i.requirements+'", but it was not included in this build.';r(i.name,i.requirements)}else r(i.name)}for(var e in t)if(t.hasOwnProperty(e)){var s=t[e],i=threedo.extend.list[s];threedo[s]=new i.Module(i)}},t=[],r=function(e,r){var i=t.indexOf(e);if(r){var n=t.indexOf(r);0>n&&(n=t.push(r)-1),t.push(0>i?e:t.splice(i,1))}else 0>i&&t.push(e)};threedo.generate=e}();
