...
;!function(){var t=function(){this.utility={},this.version="0.0.1";var t=function(){var t=$("#threedo,[data-threedoType='container']");t.each(function(){var t=$(this),e=t.attr("data-threedoName");if(!e&&i.primary)throw"A name was not provided for the threedo container";e&&(i[e]=t),i.primary||(i.primary=t),t.attr("data-threedoType","container")})},i={};Object.defineProperty(this,"$container",{get:function(){return i.primary||t(),i.primary}}),Object.defineProperty(this,"$containers",{get:function(){return i.primary||t(),i}}),this.init=function(t,i){this.initialized||(this.generate(),this.initialized=!0),this.scene=new this.Scene(t),"function"==typeof i&&i()},this.initialized=!1};window.threedo=new t}();
...
;!function(){threedo.Module=function(r){threedo.Model.call(this);var t=name;Object.defineProperty(this,"name",{get:function(){return t},set:function(e){t=e}}),this.name=r.name;var i=[];if(Object.defineProperty(this,"requirement",{set:function(e){if("object"==typeof e)for(var r in e)e.hasOwnProperty(r)&&i.indexOf(e[r])<0&&i.push(e);else i.indexOf(e)<0&&i.push(e)}}),Object.defineProperty(this,"requirements",{get:function(){return i}}),"object"==typeof r.requirements)for(var n in r.requirements)r.requirements.hasOwnProperty(n)&&(this.requirement=r.requirements[n]);else"string"==typeof r.requirements&&(this.requirement=r.requirements);if("object"==typeof r.requirements&&"object"==typeof r.requirements.libraries)for(var n in r.requirements.libraries)r.requirements.libraries.hasOwnProperty(n)&&e(r.requirements.libraries[n],r.generate)};var e=function(e,r){if("function"!=typeof e.check)throw'A "check" method is required for all libary requirements.';e.check()?r.next(r.loadOrder,r.index):$.get(e.file,function(){r.next(r.loadOrder,r.index)})};threedo.Module.prototype=Object.create(threedo.Model.prototype),threedo.Module.prototype.constructor=threedo.Module}();
...
;!function(){var e=function(){for(var e in this.extend.list)if(this.extend.list.hasOwnProperty(e)){var r=this.extend.list[e];if(threedo[r.name])throw'Modules cannot use the names of core threedo properties. You cannot add a module named "'+r.name+'".';if("object"==typeof r.requirements&&"object"==typeof r.requirements.modules&&r.requirements.modules){var o=r.requirements.modules;for(var s in o)if(o.hasOwnProperty(s)){if(!this.extend.list[o[s]])throw'The module "'+r.name+'" requires the module "'+o[s]+'", but it was not included in this build.';n(r.name,o[s])}}else if("object"==typeof r.requirements&&"string"==typeof r.requirements.modules){var d=r.requirements.modules;if(!this.extend.list[d])throw'The module "'+r.name+'" requires the module "'+d+'", but it was not included in this build.';n(r.name,d)}else n(r.name)}i(t)},t=[],n=function(e,n){var i=t.indexOf(e);if(n){var r=t.indexOf(n);0>r&&(r=t.push(n)-1),t.push(0>i?e:t.splice(i,1))}else 0>i&&t.push(e)},i=function(e,t){var t=t||0;if(e[t]){var n=e[t],r=threedo.extend.list[n];r.generate={next:i,loadOrder:e,index:++t},threedo[n]=new r.Module(r)}};threedo.generate=e}();
