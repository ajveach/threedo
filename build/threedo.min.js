...
;!function(){threedo.Cube=function(e){var e=e||{};e.noObject3D=!0,threedo.Node3D.call(this,e);var t=e.scale||[1,1,1],o=e.segments||[1,1,1],r=new THREE.BoxGeometry(t[0],t[1],t[2],o[0],o[1],o[2]),n=e.color||16777215,a=e.material||null;a||(a=new THREE.MeshLambertMaterial({color:n}));var i=new THREE.Mesh(r,a);e.rotation&&(i.rotation.x=e.rotation[0],i.rotation.y=e.rotation[1],i.rotation.z=e.rotation[2]),Object.defineProperty(this,"Mesh",{get:function(){return i},set:function(e){i=e}}),threedo.scene.add(e.name,i),this.type="Cube"},threedo.Cube.prototype=Object.create(threedo.Node3D.prototype),threedo.Cube.constructor=threedo.Cube}();
;!function(){threedo.Sphere=function(e){var e=e||{};e.noObject3D=!0,threedo.Node3D.call(this,e);var t=e.radius||1,o=e.segments||[8,6],r=e.phi||[0,2*Math.PI],n=e.theta||[0,Math.PI],a=new THREE.SphereGeometry(t,o[0],o[1],r[0],r[1],n[0],n[1]),h=e.color||16777215,i=e.material||null;i||(i=new THREE.MeshLambertMaterial({color:h}));var c=new THREE.Mesh(a,i);e.rotation&&(c.rotation.x=e.rotation[0],c.rotation.y=e.rotation[1],c.rotation.z=e.rotation[2]),Object.defineProperty(this,"Mesh",{get:function(){return c},set:function(e){c=e}}),threedo.scene.add(e.name,c),this.type="Sphere"},threedo.Sphere.prototype=Object.create(threedo.Node3D.prototype),threedo.Sphere.constructor=threedo.Sphere}();
;
