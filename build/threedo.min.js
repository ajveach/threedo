...
;!function(){threedo.Renderer=function(e){var e=e||{};e.name=e.name||"primary",threedo.Model.call(this,e);var t=e.name;Object.defineProperty(this,"name",{get:function(){return t},set:function(e){t=e}});var r=e.renderType||"WebGLRenderer";Object.defineProperty(this,"renderType",{get:function(){return r}});var n=e.$container||threedo.$container;Object.defineProperty(this,"$container",{get:function(){return n},set:function(e){n=e}});var o=e.scene||threedo.scene;Object.defineProperty(this,"scene",{get:function(){return o},set:function(e){o=e}});var i=e.camera||threedo.scene.find("mainCamera");Object.defineProperty(this,"camera",{get:function(){return i},set:function(e){i=e}});var c=e.width||n.width();Object.defineProperty(this,"width",{get:function(){return c},set:function(e){c=e,i.aspectRatio=c/a,s.setSize(c,a)}});var a=e.height||n.height();Object.defineProperty(this,"height",{get:function(){return a},set:function(e){a=e,i.aspectRatio=c/a,s.setSize(c,a)}});var d=e.backgroundColor||new THREE.Color(.2,0,.2);Object.defineProperty(this,"backgroundColor",{get:function(){return d},set:function(e){d=e,s.setClearColor(d,h)}});var h=e.backgroundAlpha||1;Object.defineProperty(this,"backgroundAlpha",{get:function(){return h},set:function(e){h=e,s.setClearColor(d,h)}}),this.render=function(){s.render(o.scene,i.Camera)},this.updateDimensions=function(){var e=n.width(),t=n.height();e!==c&&(this.width=e),e!==a&&(this.height=t)};var s=new THREE[r];i.aspectRatio=c/a,s.setSize(c,a),s.setClearColor(d,h),n.html(s.domElement),this.type="Renderer"},threedo.Renderer.prototype=Object.create(threedo.Model.prototype),threedo.Renderer.constructor=threedo.Renderer}();
;!function(){threedo.Scene=function(e){if(threedo.Model.call(this),!e.name)throw"A valid name was not provided to create this scene";var t=e.name;Object.defineProperty(this,"name",{get:function(){return t},set:function(e){t=e}});var n=45;Object.defineProperty(this,"viewAngle",{get:function(){return n},set:function(e){n=e}});var r=.1;Object.defineProperty(this,"near",{get:function(){return r},set:function(e){r=e}});var i=1e3;Object.defineProperty(this,"far",{get:function(){return i},set:function(e){i=e}});var a={};Object.defineProperty(this,"renderers",{get:function(){return a}}),Object.defineProperty(this,"renderer",{get:function(){return a.primary},set:function(e){if(!e.name)throw"The new renderer does not have a name.";if(a[e.name])throw'A renderer with the name "'+e.name+'" already exists.';a[e.name]=e}});var o=new THREE.Scene;Object.defineProperty(this,"scene",{get:function(){return o},set:function(e){o=e}});var s;Object.defineProperty(this,"backgroundColor",{get:function(){return s},set:function(e){s=e}});var c;Object.defineProperty(this,"backgroundAlpha",{get:function(){return c},set:function(e){c=e}});var d={};Object.defineProperty(this,"skybox",{get:function(){return d},set:function(e){d.materials=[];for(var t=0;t<e.length;++t)d.materials.push(new THREE.MeshBasicMaterial({map:THREE.ImageUtils.loadTexture(e[t]),side:THREE.BackSide}));d.mesh||(d.mesh=new THREE.Mesh(new THREE.BoxGeometry(i,i,i),new THREE.MeshFaceMaterial(d.materials)),o.add(d.mesh))}});var u=e.$container||threedo.$container;Object.defineProperty(this,"$container",{get:function(){return u},set:function(e){u=e}});var f={};Object.defineProperty(this,"nodes",{get:function(){return f}}),this.add=function(e){if(!f[e.name]){f[e.name]=e;var t=e.Camera||e.Mesh||e.Object3D||e.Light;return o.add(t),e}throw'A node already exists in this scene named "'+e.name+'"'},this.find=function(e){return f[e]||null};var h=.1,p=-h;this.update=function(){var e=threedo.update.time-p>=h?!0:!1;for(var t in f)f.hasOwnProperty(t)&&("function"==typeof f[t].update&&f[t].update(),e&&"function"==typeof f[t].fixedUpdate&&f[t].fixedUpdate());if(e){for(var t in a)a.hasOwnProperty(t)&&a[t].updateDimensions();p=threedo.update.time}};var m=function(){requestAnimationFrame(m),stats.begin(),threedo.update(),threedo.scene&&threedo.scene.update();for(var e in a)a.hasOwnProperty(e)&&a[e].render();stats.end()};this.type="Scene";var y=new threedo.Camera({name:"mainCamera",near:r,far:i,scene:this});this.renderer=new threedo.Renderer({name:"primary",camera:y,scene:this}),m()},threedo.Scene.prototype=Object.create(threedo.Model.prototype),threedo.Scene.prototype.constructor=threedo.Scene}();
