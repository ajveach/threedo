(function(){
	...
	var text = function(params){
		...
		obj.$e = $("<div />").addClass("threedo-UI threedo-UI-text "+params.class).html("<span>"+params.text+"</span>").attr('data-name',params.name).prependTo(threedo.scene.renderer.$container);
		obj.position();
